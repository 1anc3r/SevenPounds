...
public class HtmlHttpImageGetter implements ImageGetter {
    ...
    private static class ImageGetterAsyncTask extends AsyncTask<String, Void, Drawable> {
        ...
        protected void onPostExecute(Drawable result) {
            ...
            urlDrawable.setBounds(0, 0, (int) (result.getIntrinsicWidth() * scale * 5), (int) (result.getIntrinsicHeight() * scale * 5));
        ...
        public Drawable fetchDrawable(Resources res, String urlString) {
            try {
                ...
                drawable.setBounds(0, 0, (int) (drawable.getIntrinsicWidth() * scale * 5), (int) (drawable.getIntrinsicHeight() * scale * 5));
                return drawable;
            } catch (Exception e) {
                return null;
            }
