...
public class CardStackView extends ViewGroup implements ScrollDelegate {
    ...
    private me.lancer.sevenpounds.ui.view.cardstackview.StackAdapter mStackAdapter;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        setOverlapGapsCollapse(array.getDimensionPixelSize(R.styleable.CardStackView_stackOverlapGapsCollapse, dp2px(0)));
    ...
    public void setAdapter(me.lancer.sevenpounds.ui.view.cardstackview.StackAdapter stackAdapter) {
