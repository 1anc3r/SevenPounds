...
public class HtmlTagHandler implements Html.TagHandler {
        ...
        if (opening) {
            ...
            if (tag.equalsIgnoreCase(UNORDERED_LIST)) {
                ...
                if (tableTagLevel == 0) {
                    ...
                    me.lancer.sevenpounds.ui.view.htmltextview.ClickableTableSpan myClickableTableSpan = null;
                    if (clickableTableSpan != null) {
                        myClickableTableSpan = clickableTableSpan.newInstance();
                        myClickableTableSpan.setTableHtml(tableHtml);
                    }

                    me.lancer.sevenpounds.ui.view.htmltextview.DrawTableLinkSpan myDrawTableLinkSpan = null;
    ...
    public void setClickableTableSpan(me.lancer.sevenpounds.ui.view.htmltextview.ClickableTableSpan clickableTableSpan) {
